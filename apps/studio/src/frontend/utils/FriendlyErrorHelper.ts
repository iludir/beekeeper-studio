...
const errorMappings = {
  ...
  'oracle': [
    {
      pattern: 'thin mode',
      help: "You likely need to enable 'thick mode' which supports all connection types. Please provide the path to the Oracle Instant client to ric Studio in the box above",
